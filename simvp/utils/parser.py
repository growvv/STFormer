...
def create_parser():
    ...
    # is_train
    parser.add_argument('--is_train', default=1, type=int, help='Training or testing')
    # train_data_paths
    parser.add_argument('--train_data_paths', default="small_2000_10.npz", type=str, help='Training data paths')
    # valid_data_paths
    parser.add_argument('--valid_data_paths', default="small_2000_10.npz", type=str, help='Validation data paths')
    # test_data_paths
    parser.add_argument('--test_data_paths', default="small_2000_10.npz", type=str, help='Testing data paths')

    # save_step
    parser.add_argument('--save_step', default=1, type=int, help='Interval in epochs between saving model')
    # dataset parameters
